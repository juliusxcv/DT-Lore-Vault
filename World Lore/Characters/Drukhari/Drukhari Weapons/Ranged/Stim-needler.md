...
| Ranged       | ATK | DMG | WR                        |
| ------------ | --- | --- | ------------------------- |
| Stim-Needler | 4   | 0/0 | Range 3", Lethal 3+, Stun |
...
• **Painbringer**: Whenever an attack dice inflicts damage of 3 or more on this operative, roll one D6: on a 6, subtract 1 from that
inflicted damage.
• **Adrenalight**: STRATEGIC GAMBIT. Select one friendly operative that has this COMBAT DRUG to gain one of your
Pain tokens.
